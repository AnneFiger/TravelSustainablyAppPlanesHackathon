      ...
      <div className="main">
              ...
              <div className="icons">
                <div className="right">
                  <div
                    id="plane"
                    className={`Plane ${
                      selectedTransport === 'Plane' ? 'active' : ''
                    }`}
                    onClick={() => setSeletectedTransport('Plane')}
                  >
                  ...
                  <div
                    id="train"
                    className={`Train ${
                      selectedTransport === 'Train' ? 'active' : ''
                    }`}
                    onClick={() => setSeletectedTransport('Train')}
                  >
                ...
                <div className="left">
                  <div
                    id="car"
                    className={`Car ${
                      selectedTransport === 'Car' ? 'active' : ''
                    }`}
                    onClick={() => setSeletectedTransport('Car')}
                  >
                  ...
                  <div
                    ...
                    onClick={() => setSeletectedTransport('Boat')}
                  >
        ...
        <footer>
          ...
          <p className="missiontext">
            ...
            sources and combining it to show how really one person can
            contribute to better greener world.
          </p>
        </footer>
      </div>
    </div>
